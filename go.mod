...
require (
	...
	github.com/meka-dev/mekatek-go v0.0.2 // indirect
...
replace github.com/tendermint/tendermint => github.com/meka-dev/tendermint v0.34.20-0.20220829135135-03c9a32916f3
