...
type CosignerGRPCClient interface {
	...
	SignMekatek(ctx context.Context, in *CosignerGRPCSignMekatekRequest, opts ...grpc.CallOption) (*CosignerGRPCSignMekatekResponse, error)
}
...
func (c *cosignerGRPCClient) SignMekatek(ctx context.Context, in *CosignerGRPCSignMekatekRequest, opts ...grpc.CallOption) (*CosignerGRPCSignMekatekResponse, error) {
	out := new(CosignerGRPCSignMekatekResponse)
	err := c.cc.Invoke(ctx, "/proto.CosignerGRPC/SignMekatek", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CosignerGRPCServer interface {
	...
	SignMekatek(context.Context, *CosignerGRPCSignMekatekRequest) (*CosignerGRPCSignMekatekResponse, error)
...
func (UnimplementedCosignerGRPCServer) SignMekatek(context.Context, *CosignerGRPCSignMekatekRequest) (*CosignerGRPCSignMekatekResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignMekatek not implemented")
}
...
func _CosignerGRPC_SignMekatek_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CosignerGRPCSignMekatekRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CosignerGRPCServer).SignMekatek(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CosignerGRPC/SignMekatek",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CosignerGRPCServer).SignMekatek(ctx, req.(*CosignerGRPCSignMekatekRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CosignerGRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SignMekatek",
			Handler:    _CosignerGRPC_SignMekatek_Handler,
		},
	},
